...
const configSchema = z.object({
  ...
  FMH_QUOTE_TEMPLATE_PATH: z.string().default('templates/propuestas-fmh-2026/01-industrial-clasica-verde/01-presupuesto-industrial-clasica-verde.docx'),
  FMH_DELIVERY_NOTE_TEMPLATE_PATH: z.string().default('templates/propuestas-fmh-2026/01-industrial-clasica-verde/01-remito-industrial-clasica-verde.docx'),
  LIBREOFFICE_PATH: z.string().default(''),
  ...
  OPENAI_ENGINEERING_WEB_SEARCH_ENABLED: z.coerce.boolean().default(true),
