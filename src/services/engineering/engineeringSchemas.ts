...
export const engineeringAssistantResultSchema = z.object({
  ...
  materials: z.array(z.object({ description: z.string(), quantity: z.number().optional(), unit: z.string().optional(), estimatedWeightKg: z.number().optional(), totalLengthM: z.number().optional(), source: z.enum(['CALCULATED', 'USER', 'HISTORICAL', 'ESTIMATED']).optional() })).default([]),
  purchase: z.array(z.object({ description: z.string(), need: z.number(), unit: z.string(), commercialLength: z.number().optional(), buyQuantity: z.number().optional(), purchasedTotal: z.number().optional(), waste: z.number().optional(), stockAvailable: z.number().optional(), toBuy: z.number().optional(), price: z.number().optional(), priceStatus: z.enum(['CURRENT', 'HISTORICAL', 'ESTIMATED', 'NO_PRICE']).optional(), subtotal: z.number().optional() })).default([]),
