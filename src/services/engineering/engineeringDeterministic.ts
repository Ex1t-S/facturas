...
type KnowledgeLike = { sources?: Array<{ id: string; title: string; type: string; relevance: number; excerpt?: string }>; regulations?: Array<{ code: string; title: string; status: string; sourceUrl?: string; sourceType?: 'OFFICIAL' | 'LOCAL_VERIFIED' | 'INTERNAL' | 'SECONDARY' }> };
